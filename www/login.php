    ...
    <div id="login">
        ...
        <form name="authentication" method="post" action="index.php?page=login&action=login">
	        <table style="margin-left:auto; margin-right:auto;">
		        <tr>
			        <td class="no_align"><label for="login">Login</label></td>
			        <td class="no_align"><input name="login" id="login" type="text" size="30" /></td>
		        </tr>
		        <tr>
			        <td class="no_align"><label for="pwd">Password</label></td>
			        <td class="no_align">
