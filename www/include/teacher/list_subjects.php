...
<section>
    ...
    <div class="section">
        <table class="colored_table underlined_table">
            ...
            if(count($subjects) == 0)
            { ?>
            <tr><td colspan="2">Il n'y a aucune mati&egrave;re disponible</td></tr>
            <tr><td colspan="2"><a href="index.php?page=teacher_list_subjects&amp;<?php echo $toggle; ?>"><?php echo $link; ?></td></tr>
        <?php } 
            else
            { 
                    ...
                    <tr <?php if(!$subject->IsConfigured()) { echo 'class="unconfigured_line"'; } ?>>
	                    <td>
	                        <a href="index.php?page=teacher_subject_settings_name&amp;subject_id=<?php echo $subject->GetID(); ?>">
	                            <img src="<?php echo IMG_PATH() ?>bullet_wrench.png"/><?php echo $subject->GetName() . " - " . $subject->GetPromotion()->GetName(); ?>
	                        </a>
	                    </td>
	                    <td>
	                        <?php
